...
/**
 * Class {@link AfpRecordFND} implements {@link GenericAfpRecord} for the FND
 * record.
 * 
 ...
 * 
 */
public class AfpRecordFND extends GenericAfpRecord {

	private static final String[] CHARSET_TRY = { "cp500", "ISO-8859-1" };
	private static AfpStructuredFieldDefinitions defs;

	private static Logger LOG = Logger.getLogger(AfpRecordFND.class);
	private static String myAbbrev = "FND";
	...
	public AfpRecordFND(AfpRecord record, AfpFactory fact) throws AfpException {
	...
	public void writeData(BufferedWriter out, AfpReadWriteProperties props,
		...
		// Make string of first 32 bytes and clean it
		String typeFcDesc = null;
		for (int i = 0; i < CHARSET_TRY.length; i++) {

			String str = new String(data, 0, 32, CHARSET_TRY[i]);
